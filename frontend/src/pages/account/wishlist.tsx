...
export default function WishlistPage() {
  ...
  const handleShareWishlist = () => {
    const url = `${window.location.origin}/shared-wishlist/${Math.random().toString(36).substring(2, 15)}`;
    setShareUrl(url);
        ...
        {shareUrl && (
          <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg mt-4">
            <div className="flex items-start justify-between">
              <div>
                <h3 className="font-medium text-blue-800">Wishlist shared successfully!</h3>
                <p className="text-blue-700 text-sm mt-1">The link has been copied to your clipboard:</p>
                <p className="text-blue-900 text-sm mt-1 font-mono">{shareUrl}</p>
              </div>
              <button
