          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-sm text-neutral-500">
                {user.orders.completed} completed
              </p>
                ...
                <div className="flex items-center">
                  <div className="h-8 w-12 bg-neutral-200 rounded mr-3 flex items-center justify-center">
                    ...
                    >
                      ...
                      <path
                        fillRule="evenodd"
                        d="M1 9h22v9.5a1.5 1.5 0 01-1.5 1.5h-19A1.5 1.5 0 011 18.5V9zm5 7a1 1 0 011-1h3a1 1 0 110 2H7a1 1 0 01-1-1zm7 0a1 1 0 011-1h3a1 1 0 110 2h-3a1 1 0 01-1-1z"
                        clipRule="evenodd"
                      />
                    </svg>
                  </div>
