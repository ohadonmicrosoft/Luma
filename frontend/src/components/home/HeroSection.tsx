...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  const contentAlign = flip(
    slideAlign,
    slideAlign === "left" ? "right" : slideAlign === "right" ? "left" : "center"
  );
            ...
            >
              <div className="text-center p-8">
                <div className="text-4xl mb-4">
                  {currentSlide.id === "tactical"
                    ? "🛡️"
                    : currentSlide.id === "outdoor"
                    ? "🏕️"
                    : "🏠"}
                </div>
                <h3
                  className={cn(
                    "text-xl font-medium",
                    slideTheme === "dark" ? "text-white" : "text-neutral-800"
                  )}
                >
                  {currentSlide.title.en ||
                    Object.values(currentSlide.title)[0]}
                </h3>
              </div>
            </div>
          )}
          ...
          <div className="container mx-auto px-4">
            <div
              className={cn(
                ...
                isRTL &&
                  contentAlign !== "center" &&
                  (contentAlign === "left" ? "text-right" : "text-left")
              )}
            >
