      ...
      <div className="container mx-auto px-4">
        ...
        >
                ...
                <div
                  className={cn(
                    ...
                    contentAlignment === "right"
                      ? "bottom-8 left-0 -ml-5"
                      : "bottom-8 right-0 -mr-5"
                  )}
                >
          ...
          >
            {subtitle && (
              <div
                className={cn("mb-2 text-lg font-medium", textColors.subtitle)}
              >
                ...
                <blockquote>
                  ...
                  <div className="flex items-center">
                    {testimonial.author.image && (
                      <div
                        className={cn("flex-shrink-0", isRTL ? "ml-3" : "mr-3")}
                      >
                        <Image
                          src={testimonial.author.image}
                          alt={
                            testimonial.author.name.en ||
                            Object.values(testimonial.author.name)[0]
                          }
                          width={40}
                          height={40}
                    ...
                    <div>
                      ...
                      {testimonial.author.title && (
                        <div className={cn("text-sm", textColors.description)}>
                          <LocalizedContent
                            content={testimonial.author.title}
                          />
                        </div>
                      )}
                    </div>
