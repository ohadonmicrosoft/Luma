                ...
                >
                  ...
                  <CardContent className="p-4">
                    ...
                    {category.description && (
                      <p className={cn("text-neutral-600 mb-3 line-clamp-2", isRTL ? "text-right" : "text-left")}>
                        <LocalizedContent content={category.description} />
                      </p>
                    )}
                    
                    {/* Usage scenarios */}
                    {category.usageScenarios && category.usageScenarios.length > 0 && (
                          ...
                          >
                            {scenario.icon && (
                              <Image 
                                ...
                                width={12} 
                                height={12} 
                                className={cn("object-contain", isRTL ? "ml-1" : "mr-1")}
                              />
                            )}
                    ...
                    {category.usageScenarios && category.usageScenarios.length > 0 && (
                      <div className="space-y-3 mb-6">
                        <h4 className="font-medium text-neutral-800">
                          {isRTL ? 'سيناريوهات الاستخدام:' : 'Usage Scenarios:'}
                        </h4>
                              ...
                              {scenario.icon && (
                                <div className="flex-shrink-0">
                                  <Image 
                                    ...
                                    width={20} 
                                    height={20} 
                                    className={cn("object-contain", isRTL ? "ml-2" : "mr-2")}
                                  />
                                </div>
                              )}
                  ...
                  <div className="flex flex-col items-center text-center space-y-2">
                    ...
                    {category.featuredProducts !== undefined && (
                      <span className="text-xs text-neutral-500">
                        {category.featuredProducts} {isRTL ? 'منتجات' : 'products'}
                      </span>
                    )}
                  </div>
                </Link>
