...
router.patch(
  "/:cartId/items/:itemId",
  cartController.updateCartItemQuantity as RequestHandler
);

// Remove item from cart
router.delete(
  "/:cartId/items/:itemId",
  cartController.removeItemFromCart as RequestHandler
);
...
router.post(
  "/:cartId/gift",
  cartController.updateGiftSettings as RequestHandler
);

// Calculate shipping
router.post(
  "/:cartId/shipping",
  cartController.calculateShipping as RequestHandler
);
...
router.post(
  ...
  cartController.mergeGuestCart as RequestHandler
);
